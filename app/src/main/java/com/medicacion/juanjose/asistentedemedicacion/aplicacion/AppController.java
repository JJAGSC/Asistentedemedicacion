package com.medicacion.juanjose.asistentedemedicacion.aplicacion;
...
public class AppController extends Application {
    ...
    public static final String ACCOUNT_TYPE = "com.medicacion.juanjose.asistentedemedicacion";
    // The account name
    public static final String ACCOUNT = "Medicamentos";
